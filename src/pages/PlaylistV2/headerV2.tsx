...
export const PlaylistHeaderV2: FC<PlaylistHeaderProps> = ({ container, color, sectionContainer }) => {
          ...
          <Col xs={24} sm={18} lg={19}>
            <Col >
              ...
              />
                ...
                >
                <img src="/images/detailalbum.png" alt="" />

                  {/* <p className='playlist-title' style={{}}>
                    {playlist?.name}</p> */}
